...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    craftsmanship: tr("Cocina integrada, detalles a medida y acabados coordinados para que el apartamento se sintiera más amplio, cálido y coherente.", "Cucina integrata, dettagli su misura e finiture coordinate per far percepire l'appartamento più ampio, caldo e coerente.", "An integrated kitchen, custom details and coordinated finishes make the apartment feel wider, warmer and more coherent."),
    works: [
