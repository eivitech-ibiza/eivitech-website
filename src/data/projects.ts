...
export const PROJECTS: Project[] = [
  {
    ...
    metaDescription: tr("Renovación minimalista de apartamento en Marina Botafoch con cocina Made in Italy, mejor distribución y luz cálida.", "Ristrutturazione minimalista di appartamento a Marina Botafoch con cucina Made in Italy, migliore distribuzione e luce calda.", "Minimal apartment renovation in Marina Botafoch with Made in Italy kitchen, smarter layout and warm lighting."),
  },
  {
