...
export const PROJECTS: Project[] = [
  {
    ...
    metaTitle: tr("Ibiza Villa Value Makeover – Cala Carbó | Eivitech Ibiza", "Ibiza Villa Value Makeover – Cala Carbó | Eivitech Ibiza", "Ibiza Villa Value Makeover – Cala Carbó | Eivitech Ibiza", "Ibiza Villa Value Makeover – Cala Carbó | Eivitech Ibiza"),
    metaDescription: tr("Makeover de villa en Cala Carbó para elevar el valor percibido: microcemento, puertas rústicas, cocina ibicenca, exteriores y jardín sin cambiar la estructura principal.", "Makeover di una villa a Cala Carbó per aumentare il valore percepito: microcemento, porte rustiche, cucina ibizenca, esterni e giardino senza cambiare la struttura principale.", "Villa makeover in Cala Carbó to raise perceived value: microcement, rustic doors, an Ibizan kitchen, outdoor areas and garden without changing the main structure.", "Villamake-over in Cala Carbó om de waargenomen waarde te verhogen: microcement, rustieke deuren, een keuken in Ibizastijl, buitenruimtes en tuin zonder de hoofdstructuur te veranderen."),
  },
  {
    ...
    challenge: tr("Coordinar una reforma integral sin perder el control del detalle: obra, cartón yeso, instalaciones, climatización, acabados y soluciones a medida.", "Coordinare una ristrutturazione integrale senza perdere il controllo del dettaglio: opere, cartongesso, impianti, climatizzazione, finiture e soluzioni su misura.", "Coordinate a full renovation without losing control of detail: building work, drywall, systems, climate control, finishes and bespoke solutions.", "Een volledige renovatie coördineren zonder de details uit het oog te verliezen: bouwwerkzaamheden, gipsplaat, installaties, klimaatregeling, afwerkingen en maatwerkoplossingen."),
    ...
    works: [
      ...
      tr("Instalaciones eléctricas y climatización", "Impianti elettrici e climatizzazione", "Electrical and HVAC systems", "Elektrische installaties en klimaatregeling"),
    ...
    metaTitle: tr("Luxury Mediterranean Villa Renovation – San Antonio | Eivitech Ibiza", "Luxury Mediterranean Villa Renovation – San Antonio | Eivitech Ibiza", "Luxury Mediterranean Villa Renovation – San Antonio | Eivitech Ibiza", "Luxury Mediterranean Villa Renovation – San Antonio | Eivitech Ibiza"),
    metaDescription: tr("Reforma completa de villa en San Antonio con espacios personalizados, walk-in wardrobe, instalaciones eléctricas y climatización, carpintería y acabados a medida.", "Ristrutturazione completa di una villa a San Antonio con spazi personalizzati, cabina armadio, impianti elettrici e climatizzazione, falegnameria e finiture su misura.", "Full villa renovation in San Antonio with personalised spaces, a walk-in wardrobe, electrical and HVAC systems, carpentry and bespoke finishes.", "Volledige villarenovatie in San Antonio met gepersonaliseerde ruimtes, een inloopkast, elektrische installaties en klimaatregeling, timmerwerk en maatwerkafwerkingen."),
  },
  {
  ...
  },
  {
    ...
    short: tr("Restaurar una finca antigua sin borrar su alma: piedra original, mortero de cal natural, drenaje perimetral y materiales naturales para mejorar confort y habitabilidad.", "Restaurare una finca antica senza cancellarne l'anima: pietra originale, malta naturale a base di calce, drenaggio perimetrale e materiali naturali per migliorare comfort e abitabilità.", "Restoring an old finca without erasing its soul: original stone, natural lime mortar, perimeter drainage and natural materials to improve comfort and liveability.", "Een oude finca restaureren zonder haar ziel uit te wissen: oorspronkelijke steen, natuurlijke kalkmortel, perimeterdrainage en natuurlijke materialen voor meer comfort en bewoonbaarheid."),
    situation: tr("La casa tenía un bloque antiguo de piedra con mucha presencia, pero los muros absorbían agua y eso favorecía la formación de humedad.", "La casa aveva un antico volume in pietra di grande presenza, ma le murature assorbivano acqua favorendo la formazione di umidità.", "The house had a striking old stone volume, but the walls absorbed water, contributing to moisture formation.", "Het huis had een markant oud stenen volume, maar de muren namen water op, wat vochtvorming in de hand werkte."),
    ...
    solution: tr("La intervención se estudió para limitar la absorción de agua y ayudar a prevenir problemas de humedad en los muros, restaurando el bloque de piedra, aplicando mortero de cal natural y ejecutando un drenaje perimetral.", "L'intervento è stato studiato per limitare l'assorbimento dell'acqua e contribuire a prevenire problemi di umidità nelle murature, restaurando il volume in pietra, applicando malta naturale a base di calce e realizzando un drenaggio perimetrale.", "The intervention was designed to limit water absorption and help prevent moisture problems in the walls by restoring the stone volume, applying natural lime mortar and installing perimeter drainage.", "De ingreep is ontworpen om de wateropname te beperken en vochtproblemen in de muren te helpen voorkomen, door het stenen volume te restaureren, natuurlijke kalkmortel aan te brengen en perimeterdrainage uit te voeren."),
    ...
    craftsmanship: tr("Trabajo artesanal sobre muros de piedra, aplicación de mortero de cal natural, drenaje exterior y acabados clásicos como travertino y madera natural rústica.", "Lavoro artigianale su muri in pietra, applicazione di malta naturale a base di calce, drenaggio esterno e finiture classiche come travertino e legno naturale rustico.", "Craft work on stone walls, natural lime mortar application, exterior drainage and classic finishes such as travertine and rustic natural wood.", "Ambachtelijk werk aan stenen muren, toepassing van natuurlijke kalkmortel, buitendrainage en klassieke afwerkingen zoals travertin en rustiek natuurlijk hout."),
    works: [
      tr("Restauración de bloque antiguo de piedra", "Restauro del blocco antico in pietra", "Ancient stone volume restoration"),
      tr("Aplicación de mortero de cal natural", "Applicazione di malta naturale a base di calce", "Natural lime mortar application", "Aanbrengen van natuurlijke kalkmortel"),
    ...
    materials: [tr("Piedra original", "Pietra originale", "Original stone"), tr("Mortero de cal natural", "Malta naturale a base di calce", "Natural lime mortar", "Natuurlijke kalkmortel"), "Travertino", tr("Madera natural rústica", "Legno naturale rustico", "Rustic natural wood")],
    ...
    metaDescription: tr("Restauro de finca rústica en Ibiza con piedra antigua, mortero de cal natural, drenaje perimetral, travertino y madera natural.", "Restauro di finca rustica a Ibiza con pietra antica, malta naturale a base di calce, drenaggio perimetrale, travertino e legno naturale.", "Rustic finca restoration in Ibiza with ancient stone, natural lime mortar, perimeter drainage, travertine and natural wood.", "Restauratie van een rustieke finca op Ibiza met oude steen, natuurlijke kalkmortel, perimeterdrainage, travertin en natuurlijk hout."),
  },
  {
